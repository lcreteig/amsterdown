...
Choose any of the two methods below to finally render your thesis! It should show up in a subdirectory called  `_book`. RStudio will probably show you a preview of the result, but if not: open `_book/index.hml` if you rendered to html, or `_book/thesis.pdf` if you rendered to pdf.
